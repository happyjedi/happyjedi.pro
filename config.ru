...
use Rack::TryStatic,
    ...
    header_rules: [
              [:all, {
                  ...
                  'Content-Security-Policy' => "default-src 'self'; font-src data: 'self' https://fonts.typekit.net https://use.typekit.net; img-src 'self' http://happyjedi.pro https://p.typekit.net https://www.google-analytics.com; style-src 'self' 'unsafe-inline' https://use.typekit.net; script-src 'self' 'unsafe-inline' https://use.typekit.net https://www.google-analytics.com https://js-agent.newrelic.com https://bam.nr-data.net; child-src https://a.tiles.mapbox.com; frame-src https://a.tiles.mapbox.com;"
              }],
