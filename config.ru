...
use Rack::TryStatic,
    ...
    header_rules: [
              [:all, {
                  ...
                  'Content-Security-Policy' => "default-src 'self' www.youtube.com; connect-src data: 'self' https://links.services.disqus.com; font-src data: 'self' https://fonts.typekit.net https://use.typekit.net; img-src 'self' http://happyjedi.pro https://p.typekit.net https://www.google-analytics.com https://c.disquscdn.com https://referrer.disqus.com; style-src 'self' 'unsafe-inline' https://use.typekit.net https://c.disquscdn.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://use.typekit.net https://www.google-analytics.com https://js-agent.newrelic.com https://bam.nr-data.net https://happyjedi-pro.disqus.com https://c.disquscdn.com https://disqus.com; child-src https://a.tiles.mapbox.com; frame-src https://a.tiles.mapbox.com https://disqus.com;"
              }],
